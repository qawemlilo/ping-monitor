...
class Monitor extends EventEmitter {
  ...
  startMonitor() {
    if (this.protocol === 'http' || this.protocol === 'https') {
      ...
      // deferred so callers get a chance to attach an 'error' listener
      // after `new Monitor(...)` returns, instead of the constructor
      // throwing synchronously before any listener can be attached
      process.nextTick(() => {
